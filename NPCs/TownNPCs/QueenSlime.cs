...
namespace BossesAsNPCs.NPCs.TownNPCs
{
	...
	public class QueenSlime : ModNPC
	{
		...
		public override void SetStaticDefaults()
		{
			...
			NPCID.Sets.FaceEmote[Type] = ModContent.EmoteBubbleType<QueenSlimeEmote>();
		...
		public override void HitEffect(NPC.HitInfo hitInfo)
		{
			if (Main.netMode != NetmodeID.Server && NPC.life <= 0)
			{
				...
				for (int k = 0; k < 2; k++)
				{
					Gore.NewGore(NPC.GetSource_Death(), NPC.position, NPC.Center, ModContent.Find<ModGore>(Mod.Name + "/" + Name + "_Gore_Arm").Type, 1f);
					Gore.NewGore(NPC.GetSource_Death(), NPC.position, NPC.Center, ModContent.Find<ModGore>(Mod.Name + "/" + Name + "_Gore_Leg").Type, 1f);
				}
			}
		}
		...
		public override void AddShops()
		{
			...
			SetupShops.QueenSlime(npcShop1, Shop1);
			npcShop1.Register();

			var npcShop2 = new NPCShop(Type, Shop2);
			SetupShops.QueenSlime(npcShop2, Shop2);
			npcShop2.Register();
		}
