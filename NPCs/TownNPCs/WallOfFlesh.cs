...
namespace BossesAsNPCs.NPCs.TownNPCs
{
	...
	public class WallOfFlesh : ModNPC
	{
		...
		public override void SetStaticDefaults()
		{
			...
			NPCID.Sets.FaceEmote[Type] = ModContent.EmoteBubbleType<WallOfFleshEmote>();
		...
		public override void HitEffect(NPC.HitInfo hitInfo)
		{
			if (Main.netMode != NetmodeID.Server && NPC.life <= 0)
			{
				...
				for (int k = 0; k < 2; k++)
				{
					...
					Gore.NewGore(NPC.GetSource_Death(), NPC.Center, NPC.velocity * (k + 1), ModContent.Find<ModGore>(Mod.Name + "/" + Name + "_Gore_Flesh").Type, 1f);
				}
			}
		}
