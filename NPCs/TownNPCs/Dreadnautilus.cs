...
namespace BossesAsNPCs.NPCs.TownNPCs
{
	...
	public class Dreadnautilus : ModNPC
	{
		...
		public override void SetStaticDefaults()
		{
			...
			NPCID.Sets.FaceEmote[Type] = ModContent.EmoteBubbleType<DreadnautilusEmote>();
		...
		public override string GetChat()
		{
			...
			if (BannerSystem.GetKillCount(BannerSystem.NPCtoBanner(NPCID.BloodNautilus))  > 0)
			{
				chat.Add(Language.GetTextValue(path + "KillCount", BannerSystem.GetKillCount(BannerSystem.NPCtoBanner(NPCID.BloodNautilus)).ToString()), 0.5);
			}
		...
		public override void AddShops()
		{
			...
			SetupShops.Dreadnautilus(npcShop1, Shop1);
			npcShop1.Register();

			var npcShop2 = new NPCShop(Type, Shop2);
			SetupShops.Dreadnautilus(npcShop2, Shop2);
			npcShop2.Register();
		}
