...
namespace BossesAsNPCs.NPCs.TownNPCs
{
	...
	public class SkeletronPrime : ModNPC
	{
		...
		public override void SetStaticDefaults()
		{
			...
			NPCID.Sets.PrettySafe[Type] = 700;
			NPCID.Sets.AttackType[Type] = 0;
			NPCID.Sets.AttackTime[Type] = 90;
			NPCID.Sets.AttackAverageChance[Type] = 15;
			NPCID.Sets.HatOffsetY[Type] = 2;
			NPCID.Sets.ShimmerTownTransform[Type] = true;
			NPCID.Sets.FaceEmote[Type] = ModContent.EmoteBubbleType<SkeletronPrimeEmote>();
		...
		public override void AddShops()
		{
			...
			SetupShops.SkeletronPrime(npcShop1, Shop1);
			npcShop1.Register();

			var npcShop2 = new NPCShop(Type, Shop2);
			SetupShops.SkeletronPrime(npcShop2, Shop2);
			npcShop2.Register();
		}
