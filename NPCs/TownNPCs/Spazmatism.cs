...
namespace BossesAsNPCs.NPCs.TownNPCs
{
	...
	public class Spazmatism : ModNPC
	{
		...
		public override void SetStaticDefaults()
		{
			...
			NPCID.Sets.FaceEmote[Type] = ModContent.EmoteBubbleType<SpazmatismEmote>();
		...
		public override void HitEffect(NPC.HitInfo hitInfo)
		{
			if (Main.netMode != NetmodeID.Server && NPC.life <= 0)
			{
				...
				for (int k = 0; k < 2; k++)
				{
					Gore.NewGore(NPC.GetSource_Death(), NPC.Center, NPC.velocity, ModContent.Find<ModGore>(Mod.Name + "/Twins_Gore_Arm").Type, 1f);
				}
				Gore.NewGore(NPC.GetSource_Death(), NPC.Center, NPC.velocity, ModContent.Find<ModGore>(Mod.Name + "/EyeOfCthulhu_Gore_Leg").Type, 1f);
			}
		}
		...
		public override string GetChat()
		{
			...
			if (torchGod >= 0)
			{
				chat.Add(Language.GetTextValue(path + "TorchGod", Main.npc[torchGod].FullName));
			}
		...
		public override void AddShops()
		{
			...
			SetupShops.Spazmatism(npcShop1, Shop1);
			npcShop1.Register();

			var npcShop2 = new NPCShop(Type, Shop2);
			SetupShops.Spazmatism(npcShop2, Shop2);
			npcShop2.Register();
		}
