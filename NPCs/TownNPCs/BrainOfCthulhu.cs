...
namespace BossesAsNPCs.NPCs.TownNPCs
{
	...
	public class BrainOfCthulhu : ModNPC
	{
		...
		public override void SetStaticDefaults()
		{
			...
			NPCID.Sets.FaceEmote[Type] = ModContent.EmoteBubbleType<BrainOfCthulhuEmote>();
		...
		public override void AddShops()
		{
			...
			SetupShops.BrainOfCthulhu(npcShop1, Shop1);
			npcShop1.Register();

			var npcShop2 = new NPCShop(Type, Shop2);
			SetupShops.BrainOfCthulhu(npcShop2, Shop2);
			npcShop2.Register();
		}
